/**
 * Writes `public/figma/*` from the Figma desktop MCP asset server
 * (`http://localhost:3845/assets/...`). Run while Figma is open on the Consumer file:
 *   npm run figma:assets
 *
 * File list matches `src/lib/figmaDesignAssets.ts` (Categories, Shopping list, etc.).
 * If the server is down, use `npm run figma:seed` for minimal local placeholders only.
 */
...
const files = [
  ...
  '4417a49415614117af50208b4e376219.png',
  ...
  '9eae24bdcb2f4691b934ac93dfcfa68c.svg',
  ...
  '8763cabccfa4db2b9057b17e0301f97.svg',
  '9236160fd36c48a2a470836cd78f0709.svg',
  '9208b5e67d4c4ab894c39515e3b0afc0.svg',
...
if (fail > 0) {
  console.error('\nOpen Figma desktop with the design file, then re-run this script.')
  process.exit(1)
}
