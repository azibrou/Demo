...
/** Anchor for in-page scroll (e.g. QuickNav Categories). */
export const HOME_MORE_TO_EXPLORE_SECTION_ID = 'home-more-to-explore'

/** Node 70394:111443 — heading + horizontal category tiles */
export function MoreToExplore() {
  return (
    <section
      id={HOME_MORE_TO_EXPLORE_SECTION_ID}
